...
|----|------|--------|---------------|---------------|
| 0 | PerfectEarthBlessing | Untested |  | |
| 1 | GolemBlinker | Untested | Optional trigger from hand, bot auto-decline fix | |
| 2 | GolemThrower | Untested | Choose effect with targeting | |
| 3 | GolemTrampler | Untested | Trample, activated sacrifice | |
| 4 | GoldGolem | Untested |  | |
| 5 | StoneSculptor | Untested |  | |
| 6 | Golem | Untested |  | |
| 7 | RockGolem | Untested |  | |
| 8 | GolemFounder | Untested | Reveal effect with amountBasedOn | |
| 9 | AlchemyGolem | Untested |  | |
| 10 | IronGolems | Untested |  | |
| 11 | TransparentGolem | Untested |  | |
| 12 | StoneShaper | Untested | Choose effect with token creation | |
| 13 | ReconfigureGolem | Untested | InZone condition trigger from graveyard | |
| 14 | GolemSmasher | Untested | UI text duplication fix for granted passives | |
| 15 | ReplacerGolem | Untested | Fixed leftZone trigger (card already moved when checking) | |
| 16 | ExcavatorGolem | Untested |  | |
| 17 | Smash | Untested | X display, thisTurn buff, cancel fix | |
| 18 | GolemBlesser | Untested | Clone/owner system for self-buff fix | |
| 19 | MoltenGravel | Untested | Fixed conditional trample (GetKeywords now uses GetVerifiedPassives) | |
| 20 | ChancellorGolem | Untested | Fixed opening hand trigger zone check | |
| 21 | EarthquakeGolem | Untested |  | |
| 22 | LordGolem | Untested | Fixed aura (self: false in JSON) | |
| 23 | RockToss | Untested | Conditional damage modifier fix (effectOwner vs affectedPlayer) | |
| 24 | RockArms | Untested | Token buff fix | |
| 25 | BrassGolem | Untested | Fixed dynamic token stats (passive with amountBasedOn), baseAttack/baseDefense for color | |
| 26 | FoundryGolem | Untested | ModifyCost passive with stone condition | |
...
| 29 | Quarry | Untested | isPlayerTurn, description fix | |
| 30 | DigUp | Untested |  | |
| 31 | Stones | Untested |  | |
| 32 | StoneToss | Untested | Variable X sacrifice, X-based life cost, 2X damage | |
| 33 | Stoned | Untested |  | |
| 34 | MasterGolem | Untested | Tribute multiplier, StonesInPlay amountBasedOn | |
| 35 | RockAvalanche | Untested |  | |
